            ...
            @if (!empty($this->dataCart))
                <div class="col-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-5"></td>
                                    <td class="py-5">
                                        <p class="text-dark mb-0 py-3">Subtotal</p>
                                    </td>
                                    <td class="py-5">
                                        <div class="border-bottom border-top py-3">
                                            <p class="text-dark mb-0">
                                                {{ $item->currency . ' ' . number_format($this->dataCart->total) }}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="py-5">
                                        <p class="text-dark mb-0 py-4">Shipping</p>
                                    </td>
                                    <td class="py-5" colspan="3">
                                        <div class="form-check text-start">
                                            <input type="radio" class="form-check-input bg-primary border-0"
                                                name="Shipping-1" id="Shipping-1" value="Shipping" checked>
                                ...
                                <tr>
                                    ...
                                    <td class="py-5">
                                        <p class="text-dark text-uppercase mb-0 py-3" style="font-weight: bold;">TOTAL
                                        </p>
                                    </td>
                                    <td class="py-5"></td>
                                    <td class="py-5"></td>
                    ...
                    <div class="row g-4 align-items-center justify-content-center pt-4 text-center">
                        <button type="button" class="btn border-secondary text-uppercase w-100 text-primary px-4 py-3"
                            wire:click="processCheckout">Place
                            Order</button>
                    </div>
                </div>
            @else
                <div class="row g-4 align-items-center justify-content-center">
                    <div class="col-12">
                        <div class="alert alert-warning" role="alert">
                            Your cart is empty
                            <a class="btn border" href="{{ route('home') }}" wire:navigate>Click here to Continue
                                Shopping</a>
                        </div>
                    </div>
                </div>
